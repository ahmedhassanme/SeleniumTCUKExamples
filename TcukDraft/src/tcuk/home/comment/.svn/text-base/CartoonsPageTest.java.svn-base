...
public class CartoonsPageTest extends GlobalTests
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Cartoons Archive");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Comment cartoons archive", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
