...
public class PersonalViewPageTest extends GlobalTests 
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Personal View");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Personal View", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
