...
public class TelegraphViewPageTest extends GlobalTests
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Telegraph View");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Telegraph View", selenium.getText("//div[@id='tmglPageTitleImageLeft']/h1"));
	}
