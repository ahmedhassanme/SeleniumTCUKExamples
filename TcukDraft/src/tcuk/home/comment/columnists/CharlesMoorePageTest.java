...
public class CharlesMoorePageTest extends GlobalTests
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Charles Moore");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Charles Moore", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
