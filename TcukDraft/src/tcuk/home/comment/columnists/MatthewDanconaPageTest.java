package tcuk.home.comment.columnists;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class MatthewDanconaPageTest extends GlobalTests
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Matthew d'Ancona");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Matthew d'Ancona", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
