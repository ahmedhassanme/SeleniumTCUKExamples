package tcuk.home.culture;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class HayFestivalPageTest extends GlobalTests
{
	//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Telegraph Hay Festival");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Hay Festival", selenium.getText("//div[@id='tmglPageTitleImageRight']/h1"));
		selenium.isElementPresent("tmglPageTitleImageRight");
	}
