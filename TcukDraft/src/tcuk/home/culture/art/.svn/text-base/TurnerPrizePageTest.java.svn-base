package tcuk.home.culture.art;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class TurnerPrizePageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Turner Prize");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Turner Prize", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
