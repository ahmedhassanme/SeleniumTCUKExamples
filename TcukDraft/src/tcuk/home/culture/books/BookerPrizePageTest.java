package tcuk.home.culture.books;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class BookerPrizePageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Man Booker Prize 2010");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Man Booker Prize 2010", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
