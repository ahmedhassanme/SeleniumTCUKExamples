package tcuk.home.culture.culturecritics;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class GillianReynoldsPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Gillian Reynolds");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Gillian Reynolds", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
