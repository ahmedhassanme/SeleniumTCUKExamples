...
public class ArtVideoPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Art");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Art Video");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Art Video", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
