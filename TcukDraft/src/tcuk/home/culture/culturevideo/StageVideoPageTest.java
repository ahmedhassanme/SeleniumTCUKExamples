package tcuk.home.culture.culturevideo;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class StageVideoPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Stage Video");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Stage Video", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
