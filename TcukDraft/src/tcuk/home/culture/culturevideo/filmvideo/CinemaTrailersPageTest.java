package tcuk.home.culture.culturevideo.filmvideo;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class CinemaTrailersPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Cinema Trailers");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Cinema Trailers", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
