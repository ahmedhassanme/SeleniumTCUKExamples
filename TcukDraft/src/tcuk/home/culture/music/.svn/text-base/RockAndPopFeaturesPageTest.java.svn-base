package tcuk.home.culture.music;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class RockAndPopFeaturesPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Music");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Music Interviews");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Rock and Pop Music Features", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
