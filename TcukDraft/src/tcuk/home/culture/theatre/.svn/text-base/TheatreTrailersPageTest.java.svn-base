package tcuk.home.culture.theatre;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class TheatreTrailersPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Theatre");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Theatre Trailers");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Theatre Trailers", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
...
//////GLOBAL METHODS/////////////////////////////////////////////
	...
	{
		checkTertiaryNavigationTheatre();
	}
