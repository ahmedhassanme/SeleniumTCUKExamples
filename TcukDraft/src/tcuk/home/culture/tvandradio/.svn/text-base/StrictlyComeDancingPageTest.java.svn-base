package tcuk.home.culture.tvandradio;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class StrictlyComeDancingPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=TV and Radio");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Strictly Come Dancing");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Strictly Come Dancing 2010", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
...
//////GLOBAL METHODS/////////////////////////////////////////////
	...
	{
		checkTertiaryNavigationTvAndRadio();
	}
