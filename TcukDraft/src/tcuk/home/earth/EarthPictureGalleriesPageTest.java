package tcuk.home.earth;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class EarthPictureGalleriesPageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.click("link=Earth");
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Picture Galleries");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Earth Picture Galleries", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
