package tcuk.home.earth.environment;

import org.testng.annotations.Test;

import tcuk.GlobalTests;

public class ClimateChangePageTest extends GlobalTests
{
//////////////////////////
//////CLASS SPECIFIC METHODS/////////////////////////////////////
	...
	public void openPage() throws InterruptedException
	{
		...
		selenium.waitForPageToLoad("30000");
		selenium.click("link=Climate Change");
		selenium.waitForPageToLoad("30000");
	}
	...
	{
		checkHeader();
		assertEquals("Climate Change", selenium.getText("//div[@id='tmglPageTitle']/h1"));
	}
